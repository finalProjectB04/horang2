...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
        <td style="text-align: center;">
            <img src="image-4.png" alt="메인 페이지" style="max-width: 100%; height: auto;">
        </td>
        <td style="text-align: center;">
            <img src="image-5.png" alt="여행지 추천" style="max-width: 100%; height: auto;">
        </td>
    </tr>
</table>
...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
        <td style="text-align: center;">
            <img src="image-6.png" alt="상세 페이지" style="max-width: 100%; height: auto;">
        </td>
    </tr>
</table>
...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
        <td style="text-align: center;">
            <img src="image-7.png" alt="내 근처 여행지" style="max-width: 100%; height: auto;">
        </td>
    </tr>
</table>
...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
        <td style="text-align: center;">
            <img src="image-8.png" alt="설문조사" style="max-width: 100%; height: auto;">
        </td>
        <td style="text-align: center;">
            <img src="image-9.png" alt="여행 MBTI 유형" style="max-width: 100%; height: auto;">
        </td>
    </tr>
</table>
...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
        <td style="text-align: center;">
            <img src="image-10.png" alt="호랑이 모임" style="max-width: 100%; height: auto;">
        </td>
        <td style="text-align: center;">
            <img src="image-11.png" alt="글 작성 공간" style="max-width: 100%; height: auto;">
        </td>
    </tr>
</table>
...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
        <td style="text-align: center;">
            <img src="image-12.png" alt="나의 공간" style="max-width: 100%; height: auto;">
        </td>
    </tr>
</table>
...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
        <td style="text-align: center;">
            <img src="image-13.png" alt="호랑이 목록" style="max-width: 100%; height: auto;">
        </td>
        <td style="text-align: center;">
            <img src="image-14.png" alt="대화하기" style="max-width: 100%; height: auto;">
        </td>
    </tr>
</table>
