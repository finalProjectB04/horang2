...
const KakaoLoginButton = () => {
  ...
  return (
    <button
      onClick={kakaoLogin}
      className="flex items-center justify-center bg-[#FEE500] border border-gray-300 rounded-lg shadow-md hover:bg-yellow-400 cursor-pointer p-2 w-[400px] h-[45px]"
    >
