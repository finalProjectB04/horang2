      ...
      <div className="mx-auto max-w-[1080px]">
        <div className="flex flex-col lg:flex-row justify-between items-center ">
          ...
          <div className="lg:w-44 flex gap-4">
            <Link href="https://github.com/finalProjectB04/horang2" className="text-gray-400 hover:text-white">
        ...
        <div className="flex justify-center items-center">
          <p className="flex text-gray-400 hover:text-white mb-4 ">
            <svg
              className="w-5 h-5 text-gray-400 hover:text-white mx-4"
              fill="currentColor"
            ...
            안종현 서예은 김지환 김운성 양대우
            <svg
              className="w-4 h-4 text-gray-400 hover:text-white mx-4 "
              fill="currentColor"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            >
