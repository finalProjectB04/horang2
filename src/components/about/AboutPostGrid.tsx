...
import PostLike from "../posting/postcomponents/PostLike";
...
const AboutPostGrid: React.FC<PostGridProps> = React.memo(({ posts, selectedCategory, sortOrder }) => {
        ...
        <div className="grid grid-cols-3 gap-[15px]">
          {sortedAndFilteredPosts.map((post: Post) => (
            ...
            >
              ...
              <div className=" p-2">
                <h3 className="text-[28px] font-semibold mb-2 truncate text-white">{post.title}</h3>
...
AboutPostGrid.displayName = "AboutPostGrid";

export default AboutPostGrid;
