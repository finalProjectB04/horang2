...
const DetailPage = () => {
  ...
  return (
    <main className="mobile:max-w-[375px] tablet:max-w-[1024px] tablet:mx-auto tablet:grid tablet:justify-items-center desktop:max-w-[1440px] desktop:mx-auto desktop:grid desktop:justify-items-center">
      ...
      mobile:px-[24px] mobile:pt-[46px] mobile:pb-[17px]"
      >
        <div className="text-left tablet:flex-grow">
          <div className="desktop:text-[38px] desktop:font-bold tablet:text-[30px] tablet:font-semibold mobile:text-[14px] mobile:font-bold">
            {title}
          </div>
        </div>
        <div className="flex justify-center space-x-2 tablet:mt-0">
          ...
          <button onClick={() => setIsModalOpen(true)}>
            <Image
              ...
              width={48}
              height={48}
              className="tablet:w-12 tablet:h-12 mobile:w-[20px] mobile:h-[20px]"
            />
          </button>
