...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { answer: "아니, 쉬는 건 사치! 빈틈없이 할 수 있는 건 다 해요", type: "wanderer" },
      { answer: "여행지를 구경하고 현지문화를 체험하자구!", type: "cityTraveler" },
      { answer: "우리는 가성비! 저렴하게 산책하며 돌아다니자~", type: "cheap" },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { answer: "패러글라이딩, 보트타기 등 모든 자연 액티비티를 좋아해요", type: "active" },
      { answer: "자연은 힘들고 별로에요..", type: "luxury" },
    ],
  },
  {
    question: "여행 중 예산 관리는 어떻게 할까?",
    options: [
      { answer: "예산을 미리 계획적으로 짜두고 가성비를 중시해요", type: "cheap" },
  ...
  },
  {
    ...
    options: [
      { answer: "좋아! 여러가지 로컬 음식에 도전하는걸 즐겨요", type: "foodie" },
      { answer: "아니요, 익숙한 음식을 먹어요", type: "homebody" },
      { answer: "새로운 음식을 시도하지만 항상 낯설어요", type: "cityTraveler" },
      { answer: "음식은 곧 문화! 유명한 음식은 꼭 먹어요", type: "cultureLover" },
      { answer: "돈을 아끼자! 지역 특산물이나 재료로 직접 해먹어요", type: "cheap" },
    ],
  },
  {
    question: "우리는 J? P? 여행 중 계획을 철저히 세우나요?",
    options: [
      { answer: "네, 계획이 있어야 안심이 돼요", type: "cityTraveler" },
      { answer: "아니요, 즉흥적인 여행이 좋아요", type: "wanderer" },
      { answer: "기본적인 계획만 세워요", type: "cultureLover" },
  ...
  },
  {
    ...
    options: [
      ...
      { answer: "액티브한 활동 후, 숙소에서 느긋하게 쉬어요", type: "homebody" },
      { answer: "새로운 도시를 돌아다니며 느긋하게 사람들을 구경해요", type: "cultureLover" },
      { answer: "자연 속에서 트레킹을 하거나 계속 움직이는게 편해요", type: "active" },
    ],
  },
  {
    ...
    options: [
      ...
      { answer: "활동적인 취미나 스포츠로 스트레스를 풀기", type: "active" },
      { answer: "숙소에서 편안하게 쉬며 룸서비스를 이용하기", type: "homebody" },
      { answer: "쇼핑을 통해 스트레스를 해소하기", type: "luxury" },
      { answer: "맛있는 음식을 먹으면서 스트레스를 풀기", type: "foodie" },
    ],
  },
];
